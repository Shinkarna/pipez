...
public class EnergyPipeType extends PipeType<Void> {
    ...
    public String getTranslationKey() {
        return "tooltip.pipez_ce.energy";
    }
    ...
    public Component getTransferText(@Nullable Upgrade upgrade) {
        return Component.translatable("tooltip.pipez_ce.rate.energy", getRate(upgrade));
    }
    ...
    public void pullEnergy(PipeLogicTileEntity tileEntity, Direction side) {
        ...
        IEnergyStorage energyStorage = PipeLogicTileEntity.getEnergyHandler(tileEntity.getLevel(), extractingConnection.getPos(), extractingConnection.getDirection());
    ...
    protected void insertEqually(PipeLogicTileEntity tileEntity, Direction side, List<PipeTileEntity.Connection> connections, IEnergyStorage energyStorage) {
        ...
        for (int i = 0; i < connections.size(); i++) {
            ...
            IEnergyStorage destination = PipeLogicTileEntity.getEnergyHandler(tileEntity.getLevel(), connection.getPos(), connection.getDirection());
